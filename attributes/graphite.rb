...
default['graphite']['carbon']['uri'] = "http://launchpadlibrarian.net/82112362/carbon-#{graphite['version']}.tar.gz"
default['graphite']['carbon']['checksum'] = "b3d42e3b93c09"

default['graphite']['whisper']['uri'] = "http://launchpadlibrarian.net/82112367/whisper-#{graphite['version']}.tar.gz"
default['graphite']['whisper']['checksum'] = "66c05eafe8d86"

default['graphite']['graphite_web']['uri'] = "http://launchpadlibrarian.net/82112308/graphite-web-#{graphite['version']}.tar.gz"
